...
#
# Created: Fri Jul 13 15:54:26 2018
...
class Ui_MeshGeneratorWidget(object):
    def setupUi(self, MeshGeneratorWidget):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -211, 316, 986))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.blackfynn_groupBox = QtGui.QGroupBox(self.scrollAreaWidgetContents_2)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/meshgeneratorstep/images/download-icon-blue.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/meshgeneratorstep/images/plus-icon-green-th.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.verticalLayout_3.addWidget(self.blackfynn_groupBox)
